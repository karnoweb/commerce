...
return [
    ...
    'messages' => [
        ...
        'cannot_return_without_items' => 'Cannot create a return: at least one addItem() line is required.',
        'return_item_not_found_in_order' => 'Order item [:item] does not belong to order [:order].',
    ],
];
